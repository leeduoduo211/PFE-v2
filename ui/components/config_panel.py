...
def _sampling_control_layout():
    return {
        "columns": [1, 1, 1, 1],
        "top_row_alignment": "top",
        "bottom_row_alignment": "bottom",
    }
...
def render_config_panel(key_prefix: str = "cfg"):
    ...
    layout = _sampling_control_layout()
    with st.container(key=f"{key_prefix}_sampling_controls"):
        col1, col2, col3, col4 = st.columns(
            layout["columns"],
            gap="medium",
            vertical_alignment=layout["top_row_alignment"],
        )
        ...
        col1, col2, col3, col4 = st.columns(
            layout["columns"],
            gap="medium",
            vertical_alignment=layout["bottom_row_alignment"],
        )
